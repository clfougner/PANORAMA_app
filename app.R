    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel("About",
                 ...
                 p("Fougner, C., Höglander, E.K., Lien, T.G., Sørlie, T.S., Nord, S. & Lingjærde, O.C. A pan-cancer atlas of transcriptional dependence on DNA methylation and copy number aberrations.", tags$i("bioRxiv"), "2020.05.04.076901 (2020). doi:", a(href = "https://www.biorxiv.org/content/10.1101/2020.05.04.076901v1.full", "10.1101/2020.05.04.076901")),
                 br(),
